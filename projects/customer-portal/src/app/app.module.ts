...
import { TeambuildDetailsComponent } from './components/teambuild-details/teambuild-details.component';
import { EncodeSpacesPipe } from './pipes/encode-spaces.pipe';
import { SafeHtmlPipe } from './pipes/safe-html.pipe';
import { NotesChatComponent } from './components/notes-chat/notes-chat.component';
...
import { AddNewEmployeeDialogComponent } from './dialogs/add-new-employee-dialog/add-new-employee-dialog.component';
...
@NgModule({
  declarations: [
    ...
    LoginComponent,
    TeambuildsApproverComponent,
    TeambuildDetailsComponent,
    EncodeSpacesPipe,
    SafeHtmlPipe,
    NotesChatComponent,
  ...
  entryComponents: [AddNewEmployeeDialogComponent],
  providers:
    [CustsResolver,
      TBResolver,
